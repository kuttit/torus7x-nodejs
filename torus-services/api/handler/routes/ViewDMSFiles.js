        ...
        serhelper.GetKeyColumn(mClient, APP_ID, pDTCODE, DTT_Code, null, function keyresult(pResult) {
            ...
            reqTranDBInstance.GetTranDBConn(req.headers, false, function(pSession)

                {
                    ...
                    reqTranDBHelper.ExecuteSQLQuery(mTranDB, findtrn_idquery, objLogInfo, function(ptrnResult, pErr) {
                        if (ptrnResult.rows.length == 0) {
                            ...
                            reqTranDBHelper.ExecuteSQLQuery(mTranDB, strCommQuery, objLogInfo, function(ptrnattachResult, pErr) {
                                try {
