/*
@Api_Name         : /StartConnector,
@Description      : To Start a Connector in the kafka  Connect Service
...
router.post('/StartConnector', function (appRequest, appResponse) {
    try {
        var ServiceName = 'StartConnector';
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            ...
            if (connectorsList.length) {
                ...
                reqDBInstance.GetFXDBConnection(pHeaders, 'dep_cas', objLogInfo, function (dep_cas_instance) {
                    ...
                    reqInstanceHelper.PrintInfo(ServiceName, 'Getting Kafka Config for Redis Key - ' + kafkaConfig, objLogInfo);
