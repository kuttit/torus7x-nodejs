/*
@Api_Name         : /StopAllConnector,
@Description      : To Stop All Connector in the kafka  Connect Service
@Last_Error_code  : ERR-STOP-CONN-00002
*/
...
router.post('/StopAllConnector', function (appRequest, appResponse) {
    try {
        var ServiceName = 'StopAllConnector';
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            ...
            if (connectorsList.length) {
                reqInstanceHelper.PrintInfo(ServiceName, 'Stopping All Connector...', objLogInfo);
                reqDBInstance.GetFXDBConnection(pHeaders, 'dep_cas', objLogInfo, function (dep_cas_instance) {
                    ...
                    reqTranDBInstance.GetRedisKeyConfig(pHeaders, kafkaConfig, false, objLogInfo, function (kafkaConfig, error) {
                        ...
                        reqKafkaConnectorHelper.StopKafkaConnectors(kafkaConnectorsReqObj, function (error, kafkaConnectorsCBResult) {
                            if (error) {
