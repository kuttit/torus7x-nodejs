/*
@Api_Name         : /StopConnector,
@Description      : To Stop a Connector in the kafka  Connect Service
...
router.post('/StopConnector', function (appRequest, appResponse) {
    try {
        var ServiceName = 'StopConnector';
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            ...
            if (connectorsList.length) {
                reqInstanceHelper.PrintInfo(ServiceName, 'Stopping a Connector...', objLogInfo);
