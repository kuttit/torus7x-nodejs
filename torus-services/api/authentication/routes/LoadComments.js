...
var serviceName = 'LoadComments';

// Host api to server
router.post('/LoadComments', function (appRequest, appResponse, next) {
    var objLogInfo;
    try {
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            try {
                ...
                //objLogInfo.HANDLER_CODE = 'LoadComments';
                ...
                reqCommentHelper.LoadComments(params, headers, objLogInfo, function (error, result) {
                    try {
                        if (error) {
