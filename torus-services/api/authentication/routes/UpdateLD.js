...
var serviceName = 'UpdateLD';

// Host api to server
router.post('/UpdateLD', function (appRequest, appResponse, next) {
    var objLogInfo;
    try {
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            try {
                ...
                //objLogInfo.HANDLER_CODE = 'UpdateLD';
                ...
                reqLocalizationHelper.UpdateLD(params, headers, objLogInfo, function (error, result) {
                    try {
                        if (error) {
