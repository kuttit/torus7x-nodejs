...
var serviceName = 'InsertStaticlang';

// Host api to server
router.post('/InsertStaticlang', function (appRequest, appResponse, next) {
    var objLogInfo;
    try {
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            try {
                ...
                //objLogInfo.HANDLER_CODE = 'InsertStaticlang';
                ...
                reqLocalizationHelper.InsertStaticlang(params, headers, objLogInfo, function (error, result) {
                    try {
                        if (error) {
