...
var serviceName = 'SaveComment';

// Host api to server
router.post('/SaveComment', function (appRequest, appResponse, next) {
    var objLogInfo;
    try {
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            try {
                ...
                //objLogInfo.HANDLER_CODE = 'SaveComment';
                ...
                reqCommentHelper.SaveComment(params, headers, objLogInfo, function (error, result) {
                    try {
                        if (error) {
