...
var serviceName = 'LoadLanguageGroupKey';

// Host api to server
router.post('/LoadLanguageGroupKey', function (appRequest, appResponse, next) {
    var objLogInfo;
    try {
        ...
        reqLogInfo.AssignLogInfoDetail(appRequest, function (objLogInfo, objSessionInfo) {
            try {
                ...
                //objLogInfo.HANDLER_CODE = 'LoadLanguageGroupKey';
                ...
                reqLocalizationHelper.LoadLanguageGroupKey(params, headers, objLogInfo, function (error, result) {
                    try {
                        if (error) {
