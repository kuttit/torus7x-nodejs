...
// Host the login api
router.post('/supersetquestions', function(appReq, appResp) {
    
        reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
            reqLogWriter.Eventinsert(objLogInfo);
            objLogInfo.PROCESS = 'supersetquestions-Analytics';
            objLogInfo.ACTION = 'supersetquestions';
            var strHeader = {};
            ...
            var query = "select * from slices where tap_projectid="+appReq.body.projectid+";"
