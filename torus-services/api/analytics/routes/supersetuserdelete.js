...
// Host the login api
router.post('/supersetuserdelete', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        reqLogWriter.Eventinsert(objLogInfo);
        objLogInfo.PROCESS = 'supersetuserdelete-Analytics';
        objLogInfo.ACTION = 'supersetuserdelete';
        ...
        try {
            ...
            reqTranDBInstance.UpdateTranDBWithAudit(pSession, 'ab_user', {
                active:false
            }, {
                username:id
