...
// Host the login api
router.post('/getallconnections', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        reqLogWriter.Eventinsert(objLogInfo);
        objLogInfo.PROCESS = 'getallconnections-Analytics';
        objLogInfo.ACTION = 'getallconnections';
        ...
        try {
            ...
            reqTranDBInstance.GetTranDBConn(strHeader,false,function callbackGetTranDB(pSession){
                reqTranDBInstance.GetTableFromTranDB(pSession, 'project_connections', {}, objLogInfo, function callbackTransactionSetUpdate(pResult, pError) {
                if (pError)
