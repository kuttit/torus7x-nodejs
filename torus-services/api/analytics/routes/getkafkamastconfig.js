...
// Host the login api
router.post('/getkafkamastconfig', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
    reqLogWriter.Eventinsert(objLogInfo);
    objLogInfo.PROCESS = 'getkafkamastconfig-Analytics';
    objLogInfo.ACTION = 'getkafkamastconfig';
    var strHeader = {};
    ...
    var query = "SELECT project_id, redis_key, user_id FROM project_connections where project_id = "+appReq.body.project_id+" and user_id = "+appReq.body.usr_id+" and project_connections.redis_key LIKE '%kafka%' ;"
