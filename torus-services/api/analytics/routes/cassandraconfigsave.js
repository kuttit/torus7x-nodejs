...
// Host the login api
router.post('/cassandraconfigsave', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        reqLogWriter.Eventinsert(objLogInfo);
        objLogInfo.PROCESS = 'cassandraconfigsave-Analytics';
        objLogInfo.ACTION = 'cassandraconfigsave';
                ...
                if(error){
                  ...
                  if(err){
                    ...
                    _SendResponse('SUCCESS','','',null,null );
                        ...
                        _SendResponse({},'Key_already_exist','Error while update Programs Table',pError,null );
                          }
                      }
                    });
                }
