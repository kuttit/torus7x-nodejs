...
// Host the login api
router.post('/sparkconfigsave', function(appReq, appResp) {
    ...
    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        ...
        objLogInfo.PROCESS = 'sparkconfigsave-Analytics';
        objLogInfo.ACTION = 'sparkconfigsave';
            ...
            redisInstance.GetRedisConnection(function (error, clientR) {
                if(error){
                  ...
                  if(err){
                    ...
                    _SendResponse(object,'','',null,null );
                  }
        
                });
                        }
                      else{
                        _SendResponse({},'Key_already_exist','Error while update Programs Table','Key_already_exist',null );
                          }
                      }
                    });
                }
