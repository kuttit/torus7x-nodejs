...
// Host the login api
router.post('/dashboardprogramsinfo', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        reqLogWriter.Eventinsert(objLogInfo);
        objLogInfo.PROCESS = 'dashboardprogramsinfo-Analytics';
        objLogInfo.ACTION = 'dashboardprogramsinfo';
        ...
        try {
            ...
            reqTranDBInstance.GetTranDBConn(strHeader,false,function callbackGetTranDB(pSession){
                reqTranDBInstance.GetTableFromTranDB(pSession, 'programs', {}, objLogInfo, function callbackTransactionSetUpdate(pResult, pError) {
                if (pError)
