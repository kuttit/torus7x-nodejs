...
// Host the login api
router.post('/kafkaconnectiondelete', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        reqLogWriter.Eventinsert(objLogInfo);
        objLogInfo.PROCESS = 'kafkaconnectiondelete-Analytics';
        objLogInfo.ACTION = 'kafkaconnectiondelete';
        var strHeader = {};
        ...
        try {
            redisInstance.GetRedisConnection(function (error, clientR) {
                if(error){
                    ...
                    var redis_key_name="kafka_"+appReq.body.kafka_cluster_name
