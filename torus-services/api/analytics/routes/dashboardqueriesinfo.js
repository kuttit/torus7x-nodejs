...
// Host the login api
router.post('/dashboardqueriesinfo', function(appReq, appResp) {

    reqLogInfo.AssignLogInfoDetail(appReq, function (objLogInfo, objSessionInfo) {
        reqLogWriter.Eventinsert(objLogInfo);
        objLogInfo.PROCESS = 'dashboardqueriesinfo-Analytics';
        objLogInfo.ACTION = 'dashboardqueriesinfo';
        ...
        try {
            ...
            reqTranDBInstance.GetTranDBConn(strHeader,false,function callbackGetTranDB(pSession){
                reqTranDBInstance.GetTableFromTranDB(pSession, 'project_queries', {"project_id":4}, objLogInfo, function callbackTransactionSetUpdate(pResult, pError) {
                if (pError)
            ...
            //var select_project = "select * from al_tran.project_connections";
